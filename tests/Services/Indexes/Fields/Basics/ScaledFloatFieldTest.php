...
use Adriballa\SymfonySearchBundle\Services\Indexes\Fields\Basics\ScaledFloatField;
...
#[CoversClass(ScaledFloatField::class)]
#[CoversClass(FieldDefinition::class)]
class ScaledFloatFieldTest extends FieldDefinitionTestCase
{
    /**
    ...
    public static function sortableConfigurationDataProvider(): array
    {
        return [
            'field is sortable and searchable' => [
                ...
                'searchable' => true,
                'configuration' => [
                    'type' => FieldType::Scaled_float->value,
                ],
            ],
